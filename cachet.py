...
if __name__ == "__main__":
    ...
    statserver = cachet(baseURL='https://status.metoceanview.com/api/v1', apiToken="t9GMA7NM9SDn8FCTok9P");
    
    print statserver.ping()
    print statserver.isWorking()
    
    for comp in statserver.get("components"):
        print comp
    
    
    #statserver.createComponents(name="test", status='1', description="short test Description", order="0", groupID="7")
    statserver.updateComponentsByID(26, description="New Place holder to make group visible.", status='1', groupID='7', order='1')
    #statserver.deleteComponentsByID(31)
    print "finished"
